...
import 'visualizer_model.dart';
export 'visualizer_model.dart';
...
class _VisualizerWidgetState extends State<VisualizerWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VisualizerModel());
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    await currentUserReference!.update(createUsersRecordData(
                      points: valueOrDefault(currentUserDocument?.points, 0) -
                          (widget.points!),
                    ));
